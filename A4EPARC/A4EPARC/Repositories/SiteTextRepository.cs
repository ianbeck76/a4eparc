...
namespace A4EPARC.Repositories
{
    public class SiteTextRepository : Repository<SiteTextViewModel>, ISiteTextRepository
    {
        ...
        {
            var sitetext = HttpContext.Current.Cache["GetSiteText"] as List<SiteTextViewModel>;
            ...
            HttpContext.Current.Cache.Insert("GetSiteText", sitetext, null, DateTime.Now.AddHours(2), TimeSpan.Zero);
